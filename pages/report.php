...
<div id="time-per-project" class="summary-container">
    ...
    <?php
    $projectsCategories = \timereporting\getProjectTimeByCategory($projectId, $after, $before);
    foreach ($projectsCategories as $pid => $project) {
...
<div class="panel panel-default">
    <div class="panel-heading">
        Limiter ces tableaux à une période (limites incluses)
    </div>
